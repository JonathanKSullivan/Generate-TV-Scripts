...
The data comes [Kaggle Simpsons Script Data](https://www.kaggle.com/wcukierski/the-simpsons-by-the-data/data)
...
4. Enter the folder for the tv script generation project:
